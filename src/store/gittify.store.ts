...
const useGittifyStore = create<GittifyStore>((set) => ({
  authorName: null,
...
// if (import.meta.env.VITE_APP_ENVIRONMENT === 'development') devtools(GittifyStore);

export default useGittifyStore;
